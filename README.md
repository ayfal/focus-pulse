...
3. A document version. This is for managing your calendar, your timetable and your tasklist all in one place.
...
This version is implemented as a Word document with VBA macros, so you need to have Microsoft Word installed to use it.
??It also introduces a novel way of prioritizing tasks: by scheduling them.??
